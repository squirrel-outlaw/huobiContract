...
public class DateUtil {
    ...
    /**
     * @Author:
     * @param:   intervalHours: 间隔的小时数，例如当取24时即取第二天零点的时间戳
     * @Description: 获得从当天零点到指定间隔小时的时间戳，单位为毫秒
     * @Date:2018/4/12 0012
     */
    public static Long getHourPointTimestamp(int intervalHours){
        Calendar c = Calendar.getInstance();
        c.set(Calendar.HOUR_OF_DAY, intervalHours);
